...
def main():
    ...
    dl.append("مصادرُ الكتب الحرّة (تنزيلًا للملف أو قراءةً/تصفّحًا)، مميَّزةً: "
              "📥 **حر** (ملك عام أو متاح مجانًا من جهته) · "
              "🛒 **شراء** (محمي بحقوق النشر، يُقتنى قانونيًّا). "
              "وما كان ملفًّا حرًّا يُحفظ في مجلد `pdfs/<العلم>/` (مستثنى من git).")
    dl.append("")
